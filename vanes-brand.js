...
(function(){
  ...
  const upgrade=document.createElement('script');upgrade.src='/vanes-product-upgrade.js?v=20260914b';document.body.appendChild(upgrade);
  upgrade.onload=()=>{const context=document.createElement('script');context.src='/vanes-ai-context-fix.js?v=20260914a';document.body.appendChild(context)};
})();
